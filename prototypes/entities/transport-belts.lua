...
local entities = {
	["transport-belt"] = { type = "transport-belt", tier = 1, prog_tier = 1 },
	["fast-transport-belt"] = { type = "transport-belt", tier = 2, prog_tier = 2 },
	["express-transport-belt"] = { type = "transport-belt", tier = 3, prog_tier = 3 },
	["bob-ultimate-transport-belt"] = { type = "transport-belt", tier = 4, prog_tier = 4 },
}
