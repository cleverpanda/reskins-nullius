...
data.raw.item["nullius-underground-pipe-2"].icons[1].icon = "__boblogistics__/graphics/icons/pipe/steel-pipe-to-ground.png"
data.raw.item["nullius-underground-pipe-3"].icons[1].icon = "__boblogistics__/graphics/icons/pipe/bronze-pipe-to-ground.png"
data.raw.item["nullius-underground-pipe-4"].icons[1].icon = "__boblogistics__/graphics/icons/pipe/titanium-pipe-to-ground.png"
